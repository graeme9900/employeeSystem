...
public class frontendController {
	...
	private Boolean faceRecognitionCheckMove = false;
...
//        if(this.faceRecognitionCheckMove) {
//        	System.out.println(this.faceRecognitionCheckMove);
//			this.faceRecognitionCheckMove = false;
//        	
//        	
//        } else {
//
//        	// 提示
//        	model.addAttribute("errorMessage", "人臉不在前面");
...
//	@PostMapping("/checkInVerification/faceReturn")
//	public void uploadImage(@RequestBody String imageData, RedirectAttributes redirectAttributes) {
//
//		try {
//			// 创建 ObjectMapper 对象
...
//			if (checkFace) {
//
//				this.faceRecognitionCheckMove = true;
//
//			} else {
//				this.faceRecognitionCheckMove = false;
//			}
