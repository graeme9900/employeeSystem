...
<head>
    ...
    <script type="text/javascript">
    	function updateDepartmeantInfo(departmentID) {
    		...
    		window.location.href="./modifyAndDeleteDepartmeantInformation/update?departmentID=" + departmentID +
		...
		function deleteDepartmeantInfo(departmentID) {
			window.location.href="./modifyAndDeleteDepartmeantInformation/delete?departmentID=" + departmentID;
    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${ departmeantInfoList }" var="departmeantInfo" varStatus="status">
	        ...
	        <tr>
	            ...
	            <td>
	            	<input type="text" class="form-control" id="managerID_${ departmeantInfo.getDepartmentID() }" name="managerID_${ departmeantInfo.getDepartmentID() }" value="${departmeantInfo.getManagerID()}">
	            </td>
