	...
	<link rel="stylesheet" href="<c:url value="/resources/css/style.css" />" />
		<script type="text/javascript">
			function updateleaveRecord(leaveNumber) {
				...
				window.location.href='./falseDocumentApproval/update?leaveNumber=' + leaveNumber ;
			}
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center">簽核假單</h4>
                            ...
                            <tbody class="text-center">
                                ...
                                <c:forEach items="${ leaveRecordList }" var="leaveRecord">
                                	<tr>
	                                    ...
	                                    <td>${ leaveRecord.getLeaveStartDate().plusHours(LeaveRecord.hours) }</td>
	                                    ...
	                                    <td>
	                                        <button
												...
												value="${ leaveRecord.getLeaveNumber() }">簽核</button>
										</td>
	                                </tr>
