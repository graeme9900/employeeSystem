...
<head>
    ...
    function addListIntegerFunction(addListInteger) {
    	window.location.href='./modifyInformation/addList?action='+ addListInteger
    }
    function subListIntegerFunction(addListInteger) {
    	window.location.href='./modifyInformation/subList?action='+ addListInteger
    }
...
//     	window.location.href='./modifyInformation/updata?personName=' + personName +"&birthday=" + birthday + "&email=" + email + "&phone=" + phone + "&educationList=" + educationList.join(',') + "&workExperienceList=" + workExperienceList.join(',') + "&skillList=" + skillList.join(',') + "&interestList=" + interestList.join(',');
    	window.location.href='./modifyInformation/updata?personName=' + encodeURIComponent(personName) +
    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body ">
                        <h4 class="card-title text-center">修改資料</h4>
                        <form>
                        <div class="row">
                        <div class="col-md-6">
